# NOMBRE DE VARIABLES DE WHATSAPP
...
# root = MODEL('10')
# user = USER(root.count)
# x = user.USER_CLIENT
# print(x)

# w = MODEL(10)

# x = USER(MODEL(10).count).USER_CLIENT
# print(x)


# x = MODEL('10').MSG_UPDATE_CLIENT
# print(x)

# '/html/body/div[1]/div/div/div[5]/div/div[2]/div/div[2]/div[3]/div[23]/div/div/div[1]/div[1]/div[1]/div/div[1]/div/span[1]/span'